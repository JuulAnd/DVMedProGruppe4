...
class SHADER_OT_BUCHE (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        img1_node.location = (-400, -50)
        BASE_PATH = os.path.dirname(os.path.abspath(__file__))
        IMAGE_PATH = os.path.join(BASE_PATH, 'Images', 'Buchenrinde.jpg')
        img1_node.image = bpy.data.images.load(IMAGE_PATH)
        img1_node.label = "Add Image Node"
        img1_node.select = False        
...
class SHADER_OT_BIRKE (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        img1_node.location = (-400, -50)
        BASE_PATH = os.path.dirname(os.path.abspath(__file__))
        IMAGE_PATH = os.path.join(BASE_PATH, 'Images', 'Birkenrinde.jpg')
        img1_node.image = bpy.data.images.load(IMAGE_PATH)
        img1_node.label = "Add Image Node"
        img1_node.select = False
...
class SHADER_OT_EICHE (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        img1_node.location = (-400, -50)
        BASE_PATH = os.path.dirname(os.path.abspath(__file__))
        IMAGE_PATH = os.path.join(BASE_PATH, 'Images', 'Eichenrinde.jpg')
        img1_node.image = bpy.data.images.load(IMAGE_PATH)
        img1_node.label = "Add Image Node"
        img1_node.select = False
...
class SHADER_OT_EUK (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        img1_node.location = (-400, -50)
        BASE_PATH = os.path.dirname(os.path.abspath(__file__))
        IMAGE_PATH = os.path.join(BASE_PATH, 'Images', 'Eukrinde.jpg')
        img1_node.image = bpy.data.images.load(IMAGE_PATH)
        img1_node.label = "Add Image Node"
        img1_node.select = False
...
class SHADER_OT_FICHTE (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        img1_node.location = (-400, -50)
        BASE_PATH = os.path.dirname(os.path.abspath(__file__))
        IMAGE_PATH = os.path.join(BASE_PATH, 'Images', 'Fichtenrinde.jpg')
        img1_node.image = bpy.data.images.load(IMAGE_PATH)
        img1_node.label = "Add Image Node"
        img1_node.select = False
...
class SHADER_OT_LERCHE (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        img1_node.location = (-400, -50)
        BASE_PATH = os.path.dirname(os.path.abspath(__file__))
        IMAGE_PATH = os.path.join(BASE_PATH, 'Images', 'Lärchenrinde.jpg')
        img1_node.image = bpy.data.images.load(IMAGE_PATH)
        img1_node.label = "Add Image Node"
        img1_node.select = False
...
#________________________Shaders for Leaves_______________________________________________________
...
class SHADER_OT_COLORFUL (bpy.types.Operator): 
    ...
    def execute(self, context):
        ...
        #Add MagicTex Node
        magic_node = material_colorful.node_tree.nodes.new('ShaderNodeTexMagic')
        magic_node.location = (-400, -50)
        magic_node.turbulence_depth = 0
        magic_node.label = "Add Image Node"
        magic_node.select = False
        
        #Linking the nodes
        material_colorful.node_tree.links.new(magic_node.outputs['Color'], material_bsdf.inputs['Base Color'])
